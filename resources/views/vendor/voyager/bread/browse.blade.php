                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            <form action="{{route('admin.copy')}}" method="POST">
                                                ...
                                                <button type="submit" title="Kopiuj" class="btn btn-sm btn-warning pull-right view" style="margin-right: 5px">
                                                    <i class="voyager-pirate-swords"></i> <span class="hidden-xs hidden-sm">Kopiuj</span>
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
